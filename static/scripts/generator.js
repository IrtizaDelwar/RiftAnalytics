 ...
 function generator()
 {
  // Hard coded values for champions, items, and summoner spells. Already removed id's t hat would be invalid.
   ...
   //Randomly pick a champion ID from the array and make an ajax call to processor.py to get the information
   ...
   //Randomly pick 2 summoner spell IDs from the array and make an ajax call to processor.py to get the information
   ...
   // Randomly pick 1 Boot ID and 5 Summoner IDs from the respective arrays and make an ajax call to processor.py to get information
